import { BiWriter, BiWriterAsync, BiReaderAsync, BiReader } from 'bireader';
...
declare class JPEncode<ContextType = undefined> extends JPBase {
     ...
     */
    encodeObject(valueWriter: BiWriter<any, any>, object: Record<string, unknown>, depth?: number): number;
    /**
     ...
     * @returns The `number` of bytes written
     */
    encodeArray(valueWriter: BiWriter<any, any>, array: Array<unknown>, depth?: number): number;
    /**
     ...
     * @returns The `number` of bytes written
     */
    encodeString(valueWriter: BiWriter<any, any>, string: string, isKey?: boolean): number;
    /**
     ...
     * @returns The `number` of bytes written
     */
    encodeNull(valueWriter: BiWriter<any, any>): number;
    /**
     ...
     * @returns The `number` of bytes written
     */
    encodeUndefined(valueWriter: BiWriter<any, any>): number;
    /**
     ...
     * @returns The `number` of bytes written
     */
    encodeBoolean(valueWriter: BiWriter<any, any>, object: boolean): number;
    /**
     ...
     * @returns The `number` of bytes written
     */
    encodeFinished(valueWriter: BiWriter<any, any>): number;
    /**
     ...
     * @returns The `number` of bytes written
     */
    encodeListEnd(valueWriter: BiWriter<any, any>): number;
    /**
     ...
     * @returns The `number` of bytes written
     */
    encodeNumber(valueWriter: BiWriter<any, any>, number: number): number;
    /**
     ...
     * @returns The `number` of bytes written
     */
    encodeBigInt64(valueWriter: BiWriter<any, any>, bigint: bigint): number;
     ...
     * @returns The `number` of bytes written
     */
    encodeMap<K, V>(valueWriter: BiWriter<any, any>, object: Map<K, V>, depth?: number): number;
    /**
     ...
     * @returns The `number` of bytes written
     */
    encodeSet<T>(valueWriter: BiWriter<any, any>, object: Set<T>, depth?: number): number;
    /**
     ...
     * @returns The `number` of bytes written
     */
    encodeSymbol(valueWriter: BiWriter<any, any>, object: symbol): number;
    /**
     ...
     * @returns The `number` of bytes written
     */
    encodeRegEx(valueWriter: BiWriter<any, any>, object: RegExp): number;
    /**
     ...
     * @returns The `number` of bytes written
     */
    encodeBinary(valueWriter: BiWriter<any, any>, object: Buffer | ArrayBufferView): number;
    /**
     ...
     * @returns The `number` of bytes written
     */
    encodeDate(valueWriter: BiWriter<any, any>, object: Date): 7 | 11 | 15;
    /**
 ...
 * Create with `EncoderOptions`
 */
declare class JPEncodeAsync<ContextType = undefined> extends JPBaseAsync {
    private readonly extensionCodec;
    private readonly context;
    private stringList;
    private keyList;
     ...
     * @returns {Buffer}
     */
    encode(object: unknown, filePath?: string): Promise<Buffer>;
    private reinitializeState;
    private doEncode;
    /**
     * Writes an `Object` to the buffer as `Record<string, unknown>`
     ...
     * @returns The `number` of bytes written
     */
    encodeObject(valueWriter: BiWriterAsync<any, any>, object: Record<string, unknown>, depth?: number): Promise<number>;
    /**
     * Writes an `Array` to the buffer as `Array<unknown>`
     *
     * @param valueWriter - Writer
     ...
     * @returns The `number` of bytes written
     */
    encodeArray(valueWriter: BiWriterAsync<any, any>, array: Array<unknown>, depth?: number): Promise<number>;
    /**
     * Writes a `string` to the buffer's string section.
     *
     * @param valueWriter - Writer
     ...
     * @returns The `number` of bytes written
     */
    encodeString(valueWriter: BiWriterAsync<any, any>, string: string, isKey?: boolean): Promise<number>;
    /**
     * Writes a `null` to the buffer
     *
     * @param valueWriter - Writer
     * @returns The `number` of bytes written
     */
    encodeNull(valueWriter: BiWriterAsync<any, any>): Promise<number>;
    /**
     * Writes an `undefined` to the buffer
     *
     * @param valueWriter - Writer
     * @returns The `number` of bytes written
     */
    encodeUndefined(valueWriter: BiWriterAsync<any, any>): Promise<number>;
    /**
     * Writes a `boolean` true or false to the buffer
     *
     * @param valueWriter - Writer
     ...
     * @returns The `number` of bytes written
     */
    encodeBoolean(valueWriter: BiWriterAsync<any, any>, object: boolean): Promise<number>;
    /**
     * Writes an "finished" byte to the buffer. End the loop when hit if not finished otherwise.
     *
     * @param valueWriter - Writer
     * @returns The `number` of bytes written
     */
    encodeFinished(valueWriter: BiWriterAsync<any, any>): Promise<number>;
    /**
     * Writes a "list end" byte to the buffer, useful when pulling loose data and don't want to break the whole loop.
     *
     * @param valueWriter - Writer
     * @returns The `number` of bytes written
     */
    encodeListEnd(valueWriter: BiWriterAsync<any, any>): Promise<number>;
    /**
     * Writes a `number` to the buffer . Computes the right byte size base on value.
     *
     * Notes: Use `encodeBigInt64` for `bigint` types.
     ...
     * @returns The `number` of bytes written
     */
    encodeNumber(valueWriter: BiWriterAsync<any, any>, number: number): Promise<number>;
    /**
     * Writes a `bigint` to the buffer. Always written as a 64 bit value.
     *
     * @param valueWriter - Writer
     ...
     * @returns The `number` of bytes written
     */
    encodeBigInt64(valueWriter: BiWriterAsync<any, any>, bigint: bigint): Promise<number>;
    private encodeStringHeader;
    private writeString;
    private writeStringsData;
    private encodeNumberAsFloat;
     ...
     * @returns The `number` of bytes written
     */
    encodeMap<K, V>(valueWriter: BiWriterAsync<any, any>, object: Map<K, V>, depth?: number): Promise<number>;
    /**
     * Writes a `Set` to the buffer as `Set<type>`
     *
     * @param valueWriter - Writer
     ...
     * @returns The `number` of bytes written
     */
    encodeSet<T>(valueWriter: BiWriterAsync<any, any>, object: Set<T>, depth?: number): Promise<number>;
    /**
     * Writes a `symbol` to the buffer
     *
     * @param valueWriter - Writer
     ...
     * @returns The `number` of bytes written
     */
    encodeSymbol(valueWriter: BiWriterAsync<any, any>, object: symbol): Promise<number>;
    /**
     * Writes a `RegEx` to the buffer
     *
     * @param valueWriter - Writer
     ...
     * @returns The `number` of bytes written
     */
    encodeRegEx(valueWriter: BiWriterAsync<any, any>, object: RegExp): Promise<number>;
    /**
     * Writes a `TypedArray` or `Buffer` to the buffer
     *
     * @param valueWriter - Writer
     ...
     * @returns The `number` of bytes written
     */
    encodeBinary(valueWriter: BiWriterAsync<any, any>, object: Buffer | ArrayBufferView): Promise<number>;
    /**
     * Writes a `Date` to the buffer
     *
     * @param valueWriter - Writer
     ...
     * @returns The `number` of bytes written
     */
    encodeDate(valueWriter: BiWriterAsync<any, any>, object: Date): Promise<7 | 11 | 15>;
    /**
     * Creates headers buffer.
     *
     * Note: Must have compressed or encrypted data already.
 ...
 */
declare class JPDecodeAsync<ContextType = undefined> extends JPBaseAsync {
    private readonly extensionCodec;
    private readonly context;
     ...
     */
    decode(bufferOrSourcePath: Buffer | ArrayLike<number> | Uint8Array<ArrayBufferLike> | ArrayBufferView | ArrayBufferLike | string): Promise<unknown>;
     ...
     */
    doDecodeAsync(bufferOrReader: Buffer | BiReaderAsync<any, any>): Promise<unknown>;
    /**
     * Runs a raw decode on the passed value buffer as `Buffer` or `BiReader`. Return data wherever it ends based on the start value.
     *
     ...
     * @returns Decoded data
     */
    doDecode(bufferOrReader: Buffer | BiReaderAsync<any, any>): Promise<unknown>;
...
type JPExtensionDecoderAsyncType<ContextType> = (data: BiReaderAsync<any, any>, decoder: JPDecodeAsync<ContextType>, type: number, context: ContextType) => Promise<unknown>;
type JPExtensionDecoderType<ContextType> = (data: BiReader<any, any>, decoder: JPDecode<ContextType>, type: number, context: ContextType) => unknown;
type JPExtensionEncoderAsyncType<ContextType> = (input: unknown, encoder: JPEncodeAsync<ContextType>, context: ContextType) => Promise<Buffer | null>;
...
declare class JPExtensionCodec<ContextType = undefined> implements JPExtensionCodecType<ContextType> {
    ...
    private readonly encodersAsync;
    private readonly decoders;
    private readonly decodersAsync;
    constructor(extension?: JPExtensionType<ContextType>);
    register(extension: JPExtensionType<ContextType>): void;
    tryToEncode(object: unknown, encoder: JPEncode<ContextType>, context: ContextType): JPExtData | null;
    tryToEncodeAsync(object: unknown, encoder: JPEncodeAsync<ContextType>, context: ContextType): Promise<JPExtData | null>;
    decode(data: BiReader<any, any>, decoder: JPDecode<ContextType>, type: number, context: ContextType): unknown;
    decodeAsync(data: BiReaderAsync<any, any>, decoder: JPDecodeAsync<ContextType>, type: number, context: ContextType): Promise<unknown>;
...
declare class JPBase {
    ...
    useFile: boolean;
    valueWriter: BiWriter<any, any> | null;
    strWriter: BiWriter<any, any> | null;
    compWriter: BiWriter<any, any> | null;
    fileReader: BiReader<any, any> | null;
    valueReader: BiReader<any, any> | null;
    strReader: BiReader<any, any> | null;
    compReader: BiReader<any, any> | null;
    /**
     * Buffer size. 16mbs
     */
    growthIncrement: number;
...
declare class JPBaseAsync {
    /**
     * Buffer for header data.
     */
    headerBuffer: Buffer | null;
    useFile: boolean;
    valueWriterAsync: BiWriterAsync<any, any> | null;
    strWriterAsync: BiWriterAsync<any, any> | null;
    compWriterAsync: BiWriterAsync<any, any> | null;
    fileReaderAsync: BiReaderAsync<any, any> | null;
    valueReaderAsync: BiReaderAsync<any, any> | null;
    strReaderAsync: BiReaderAsync<any, any> | null;
    compReaderAsync: BiReaderAsync<any, any> | null;
    /**
     * Buffer size. 16mbs
     */
    growthIncrement: number;
...
export { JPDecode, JPDecodeAsync, JPEncode, JPEncodeAsync, JPExtData, JPExtType, JPExtensionCodec, JPType };
