...
class JPBaseAsync {
    ...
    ////////////////
    useFile = false;
    valueWriterAsync = null;
    strWriterAsync = null;
    compWriterAsync = null;
    ////////////////
    //  READERS   //
    ////////////////
    fileReaderAsync = null;
    valueReaderAsync = null;
    strReaderAsync = null;
    compReaderAsync = null;
    ////////////////
    //   SIZES    //
    ////////////////
    /**
...
class JPDecode extends JPBase {
    extensionCodec;
    context;
    mapKeyConverter = mapKeyConverter$1;
...
class JPEncodeAsync extends JPBaseAsync {
    ...
    async encodeMap(valueWriter, object, depth) {
        ...
        await this.valueWriterAsync.ubyte(JPExtType.Maps);
        length++;
        for (const key of keys) {
            const value = object.get(key);
    ...
    async encodeBinary(valueWriter, object) {
        ...
        if (object instanceof Buffer) {
            await valueWriter.ubyte(JPExtType.Buffer);
            length++;
